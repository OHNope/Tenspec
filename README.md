For transparency: I used GPT-5.5 to help write parts of the README, CI, benchmarks, and scripts. I also used it for some repetitive code, such as macro boilerplate and similar consteval type-deduction code. That does not mean the whole project was generated by AI; the design, type model, ownership semantics, and final code decisions were done and verified by me.
